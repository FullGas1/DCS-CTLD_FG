...
- **MT-10b — AI _assignPostSpawnTask gotoAttackNearestEnemyOnLos** : ✅ PASS live DCS [2026-05-20] — log confirme coords ennemi RED en LOS (727m, LOS=true) + mouvement troupes vers ennemi observé DCS ; ⚠️ re-recette Feature S (zones native) à planifier
