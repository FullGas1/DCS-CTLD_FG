-- diag_fi_wpz.lua — cleanup + reset step counters for FI-WPZ and FI-ATK scenarios
_G["_FI_WPZ_STEP"]      = 1
_G["_FI_WPZ_DEST"]      = nil
_G["_FI_WPZ_DIST_ORIG"] = nil
_G["_FI_ATK_STEP"]      = 1
_G["_FI_ATK_ENEMY_PT"]  = nil
_G["_FI_ATK_SPAWN_PT"]  = nil
...
-- Remove draw marks (FI-WPZ: 99901-99932 + 99999 / FI-ATK: 98801-98901)
for i = 1, 33 do pcall(function() trigger.action.removeMark(99900 + i) end) end
