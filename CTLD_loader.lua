...
dofile(CTLD_SOURCE_PATH .. "CTLD_objectsDescDb.lua")
-- Business domain managers
dofile(CTLD_SOURCE_PATH .. "CTLD_scene.lua")
...
dofile(CTLD_SOURCE_PATH .. "scenes/CTLD_farpSceneDatas.lua")
dofile(CTLD_SOURCE_PATH .. "scenes/CTLD_fobSceneDatas.lua")
dofile(CTLD_SOURCE_PATH .. "scenes/CTLD_mineFieldSceneDatas.lua")
dofile(CTLD_SOURCE_PATH .. "scenes/CTLD_aaHawkSceneDatas.lua")
dofile(CTLD_SOURCE_PATH .. "scenes/CTLD_aaPatriotSceneDatas.lua")
dofile(CTLD_SOURCE_PATH .. "scenes/CTLD_aaNasamSceneDatas.lua")
dofile(CTLD_SOURCE_PATH .. "scenes/CTLD_aaBukSceneDatas.lua")
dofile(CTLD_SOURCE_PATH .. "scenes/CTLD_aaKubSceneDatas.lua")
dofile(CTLD_SOURCE_PATH .. "scenes/CTLD_aas300SceneDatas.lua")
